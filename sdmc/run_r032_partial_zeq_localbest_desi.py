...
OUT=Path("output/partial_zeq_localbest_desi")
...
summary={
    "LCDM":totals["LCDM"],
    "PARTIAL_ZEQ_LOCALBEST":totals["PARTIAL_ZEQ_LOCALBEST"],
    "delta_partial_zeq_localbest_minus_lcdm":totals["PARTIAL_ZEQ_LOCALBEST"]-totals["LCDM"],
}
pd.DataFrame(allrows).to_csv(OUT/"partial_zeq_localbest_desi_profile.csv",index=False)
(OUT/"partial_zeq_localbest_desi_summary.json").write_text(json.dumps(summary,indent=2))
