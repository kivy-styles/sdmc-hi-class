...
AF=0.023762485918098347
ZC=4.101487523488081
WIDTH=0.31436074855583374
D0=0.34231919445927034
POWER=1.0
DFLOOR=0.050064040723612924
...
Path("output/cov_exact_reconstruction_summary.txt").write_text(
    ...
    f"D_independent=0.050064040723612924+0.34231919445927034*S\\n"
