...
models=[
    ...
    ("LCDM_LOCAL021",model_data('lcdm_021',68.56858744695782,0.022406369378007947,0.11824151052483357,0.9649593164240942)),
]
...
for x in summary:
    ...
    print("LCDM_LOCAL021_DESI_SUMMARY",x,flush=True)
pd.DataFrame(rows).to_csv(OUT/'lcdm_local021_desi_profile.csv',index=False)
pd.DataFrame(summary).to_csv(OUT/'lcdm_local021_desi_summary.csv',index=False)
