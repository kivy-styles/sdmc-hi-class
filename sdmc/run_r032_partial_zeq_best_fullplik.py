...
OUT=Path("output/partial_zeq_local_best_fullplik")
...
CANDIDATES=[
    dict(id="partial_zeq_local_best",H0=70.69065645344024,ob=0.022063253393818805,
...
pd.DataFrame(rows).to_csv(OUT/"partial_zeq_local_best_fullplik.csv",index=False)
...
(OUT/"partial_zeq_local_best_fullplik_summary.json").write_text(json.dumps(summary,indent=2))
