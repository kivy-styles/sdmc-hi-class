...
OUT=Path("output/local002_expansion_refine"); OUT.mkdir(parents=True,exist_ok=True)
...
LAMS=[17.30,17.60,17.925,18.25,18.60]
ZTS =[17.10,17.45,17.775,18.10,18.45]
...
df=pd.DataFrame(rows); df.to_csv(OUT/"local002_expansion_refine.csv",index=False)
