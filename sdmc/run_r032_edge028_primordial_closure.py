#!/usr/bin/env python3
"""
Primordial closure around the exact-promoted edge028 structural solution.
...
OUT=Path("output/edge028_primordial_closure"); OUT.mkdir(parents=True,exist_ok=True)
...
df.to_csv(OUT/"edge028_primordial_closure.csv",index=False)
...
(OUT/"edge028_primordial_closure_summary.json").write_text(json.dumps(summary,indent=2))
