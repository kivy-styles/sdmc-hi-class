...
CANDIDATES=[
    dict(id="partial_zeq_edge_best",H0=70.86703259055196,ob=0.022095790254388462,
         oc=0.1228104345825064,ns=0.9625227132590487,tau=0.055202901571989066,
         lnAs=3.0598696043919773,AF=0.0518125,
         zc=2.89875,width=0.526875,dfloor=0.041421875,
         lam=18.496875000000003,zt=16.6578125),
]
def table(path):
    import re
