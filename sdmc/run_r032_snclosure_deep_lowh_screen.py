#!/usr/bin/env python3
"""
Deep low-H SN-aware closure screen around the exact sobol006 basin with structure frozen.
...
OUT=Path("output/snclosure_deep_lowh"); OUT.mkdir(parents=True,exist_ok=True)
