...
OUT=Path("output/sobol049_primordial_refine")
...
CANDIDATES=[
    dict(id="base",H0=70.6661848725751,ob=0.02213832986768335,oc=0.12419066331610083,AF=0.05709640212077647,zc=2.8532181778922676,width=0.575869657304138,ns=0.9614044621046632,tau=0.05464880801877007,lnAs=3.051477308589965),
    dict(id="ns9604",H0=70.6661848725751,ob=0.02213832986768335,oc=0.12419066331610083,AF=0.05709640212077647,zc=2.8532181778922676,width=0.575869657304138,ns=0.9604,tau=0.05464880801877007,lnAs=3.051477308589965),
    dict(id="ns9622",H0=70.6661848725751,ob=0.02213832986768335,oc=0.12419066331610083,AF=0.05709640212077647,zc=2.8532181778922676,width=0.575869657304138,ns=0.9622,tau=0.05464880801877007,lnAs=3.051477308589965),
    dict(id="ns9630",H0=70.6661848725751,ob=0.02213832986768335,oc=0.12419066331610083,AF=0.05709640212077647,zc=2.8532181778922676,width=0.575869657304138,ns=0.9630,tau=0.05464880801877007,lnAs=3.051477308589965),
    dict(id="tau0520",H0=70.6661848725751,ob=0.02213832986768335,oc=0.12419066331610083,AF=0.05709640212077647,zc=2.8532181778922676,width=0.575869657304138,ns=0.9614044621046632,tau=0.0520,lnAs=3.046179692552425),
    dict(id="tau0570",H0=70.6661848725751,ob=0.02213832986768335,oc=0.12419066331610083,AF=0.05709640212077647,zc=2.8532181778922676,width=0.575869657304138,ns=0.9614044621046632,tau=0.0570,lnAs=3.056179692552425),
    dict(id="qminus004",H0=70.6661848725751,ob=0.02213832986768335,oc=0.12419066331610083,AF=0.05709640212077647,zc=2.8532181778922676,width=0.575869657304138,ns=0.9614044621046632,tau=0.05464880801877007,lnAs=3.047477308589965),
    dict(id="qplus004",H0=70.6661848725751,ob=0.02213832986768335,oc=0.12419066331610083,AF=0.05709640212077647,zc=2.8532181778922676,width=0.575869657304138,ns=0.9614044621046632,tau=0.05464880801877007,lnAs=3.055477308589965),
    dict(id="combo1",H0=70.6661848725751,ob=0.02213832986768335,oc=0.12419066331610083,AF=0.05709640212077647,zc=2.8532181778922676,width=0.575869657304138,ns=0.9622,tau=0.0525,lnAs=3.047179692552425),
    dict(id="combo2",H0=70.6661848725751,ob=0.02213832986768335,oc=0.12419066331610083,AF=0.05709640212077647,zc=2.8532181778922676,width=0.575869657304138,ns=0.9622,tau=0.0535,lnAs=3.047179692552425),
]
...
def ini(root,c):
    ...
    parameters_smg = {float(c["AF"]):.17g},{float(c["zc"]):.17g},{float(c["width"]):.17g},{D0:.17g},1.0,{DFLOOR}
...
for c in CANDIDATES:
    ...
    if cp.returncode:
        print("S49PR_CLASS_FAIL",c["id"],cp.stdout[-3000:],flush=True)
    ...
    print("S49PR_STABILITY",json.dumps(rec,sort_keys=True),flush=True)
...
def run_one(label,path,seeds):
    ...
    for i,seed in enumerate(seeds):
        ...
        print("S49PR_FULLPLIK_SEED",label,i,row[0],row[2],row[3],flush=True)
    ...
    print("S49PR_FULLPLIK_RESULT",json.dumps(row,sort_keys=True),flush=True)
    return row,x
...
for c in CANDIDATES:
    ...
    rows.append(row)
    print("S49PR_FULLPLIK_DELTA",c["id"],row["delta_chi2_vs_lcdm"],flush=True)

pd.DataFrame(rows).to_csv(OUT/"sobol049_primordial_fullplik.csv",index=False)
...
(OUT/"sobol049_primordial_fullplik_summary.json").write_text(json.dumps(summary,indent=2))
print("S49PR_FULLPLIK_SUMMARY",json.dumps(summary,sort_keys=True),flush=True)
