...
design=[
 ("quadratic_refined",0.9616572228574438,3.068517558880833,0.058260117029514044),
 ("grid_best",0.960,3.068,0.0584),
 ("fast_best",0.964,3.066,0.0584),
]
rows=[]
...
df=pd.DataFrame(rows); df.to_csv(OUT/"refined_primordial_validation.csv",index=False)
...
short.to_csv(OUT/"refined_primordial_validation_shortlist.csv",index=False)
