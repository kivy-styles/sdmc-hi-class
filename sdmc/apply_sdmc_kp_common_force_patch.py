#!/usr/bin/env python3
"""Patch CLASS with the Part-VI reciprocal Kp common acceleration.
...
new="""  double delta_g=0.,theta_g=0.,shear_g=0.;
  double delta_b,theta_b;
  /* SDMC_KP_RECIPROCAL_COMMON_FORCE */
...
print(f'Applied reciprocal common-force Kp operator: Cmin={a.cmin:.9g}, zoff={a.zoff:.9g}, zon={a.zon:.9g}, dz={a.dz:.9g}')
