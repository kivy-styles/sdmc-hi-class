...
models=[
  ...
  ("LCDM_SOBOL054",OUT/"lcdm_sobol054_00_cl_lensed.dat"),
  ("LCDM_SOBOL023",OUT/"lcdm_sobol023_00_cl_lensed.dat"),
]
...
for a,b in [("LCDM_SOBOL054","LCDM_REFERENCE"),("LCDM_SOBOL023","LCDM_REFERENCE"),("LCDM_SOBOL054","LCDM_SOBOL023")]:
    d=r[a]["chi2_profile_total"]-r[b]["chi2_profile_total"]
    print("LCDM_CONTROL_FULLPLIK_DELTA",a,"MINUS",b,d,flush=True)

fields=list(results[0].keys())
with (OUT/"lcdm_control_fullplik_profile.csv").open("w",newline="") as f:
