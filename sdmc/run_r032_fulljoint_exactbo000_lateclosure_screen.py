#!/usr/bin/env python3
"""
Focused late-background joint-closure screen around exactbo000 with its validated structure and ordinary sector frozen.
...
OUT=Path("output/fulljoint_exactbo000_lateclosure"); OUT.mkdir(parents=True,exist_ok=True)
TMP=OUT/"tmp"; TMP.mkdir(exist_ok=True)
SNROOT=Path("sn_data")
BAOROOT=Path("bao_data")

# Validated exactbo000 structural / primordial anchor.
OB=0.02208511574370519
OC=0.12298509428428875
AS=2.1197359302086e-9
NS=0.962555355281866
...
A0=0.010977504386967048
B0=0.012857573034386149
H00=69.81677547364065
EDGE024_PD_FAIR=0.0018283254926245718
...
Alo,Ahi=0.0060,0.0135
Blo,Bhi=0.0095,0.0145
Hlo,Hhi=69.30,69.84
rows=[]
