...
design=[
 ...
 ("diag_target_ns964",0.964,3.066,0.0584),
 ("diag_target_ns968",0.968,3.066,0.0584),
 ("tau0604_A3063_ns964",0.964,3.063,0.0604),
 ("tau0604_A3068_ns968",0.968,3.068,0.0604),
 ("tau0624_A3063_ns968",0.968,3.063,0.0624),
]
rows=[]
...
df=pd.DataFrame(rows); df.to_csv(OUT/"physical_plus_primordial_fast.csv",index=False)
...
short.to_csv(OUT/"physical_plus_primordial_fast_shortlist.csv",index=False)
