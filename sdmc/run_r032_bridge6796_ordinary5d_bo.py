...
OUT=Path("output/bridge6796_ordinary5d")
...
summary=dict(
  target="bridge6796 Planck recovery with >=2 exact SN deltas <=0",
  ...
  note="Direct SN deltas use matched LCDM exact covariance baselines; top points require exact raw-DESI + full-Plik replay."
)
